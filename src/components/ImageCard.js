  ...
  function ImageCard(_ref) {
    ...
    return R.createElement('div', { className:'swipe-wrapper', ref:sw.wrapperRef },
      !isNewCard && R.createElement('div', { className:'swipe-actions' },
        R.createElement('button', { ref:sw.btn1Ref, className:'swipe-action-btn', style:{ background:'#ff9500', transform:'translateX(60px)', opacity:0 }, onClick:function(e){e.stopPropagation();sw.snapClose();onPin(memo.id);} },
